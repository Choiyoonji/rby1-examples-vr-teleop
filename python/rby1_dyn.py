...
class RBY1Dyn:
    def __init__(self):
        self.robot = load_robot_from_urdf("/home/choiyj/rby1-sdk/models/rby1a/urdf/model_v1.2.urdf", base_link_name="base")
...
if __name__ == "__main__":
    rby1_dyn = RBY1Dyn()
    joint_positions = np.zeros(len(RBY1_JOINT_NAMES))
